...
- `basma2.c`  
  Contains `main()` that calls `hello()`. When linked with `basma1.c`, they form one program.
...
- `answers.txt`  
  Short written basmaanswers explaining what each exercise does and the roles of the linker and loader.
